...
import { I{{ input | pascal }}Props, {{ input | pascal }} } from '../../../atomic/organism/{{ input | pascal }}'
import { mockTestID, StorybookHoc as wrapper } from '../../../utils'

describe('Organisms/{{ input | pascal }}', () => {
...
```jsx
import * as React from 'react'
import { {{ input | pascal }} } from '../../../atomic/organism/{{ input | pascal }}'
