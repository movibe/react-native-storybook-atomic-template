...
import { I{{ input | pascal }}Props, {{ input | pascal }} } from '../../../atomic/molecules/{{ input | pascal }}'
import { mockTestID, StorybookHoc as wrapper } from '../../../utils'

describe('Molecules/{{ input | pascal }}', () => {
...
```jsx
import * as React from 'react'
import { {{ input | pascal }} } from '../../../atomic/molecules/{{ input | pascal }}'
