...
import { I{{ input | pascal }}Props, {{ input | pascal }} } from '../../../atomic/templates/{{ input | pascal }}'
import { mockTestID, StorybookHoc as wrapper } from '../../../utils'

describe('Templates/{{ input | pascal }}', () => {
...
```jsx
import * as React from 'react'
import { {{ input | pascal }} } from '../../../atomic/templates/{{ input | pascal }}'
